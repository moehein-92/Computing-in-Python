...
def to_dictionaries(lst):
    dict = {}
    for i in lst:
        dict[i.short_name] = {}
        dict[i.short_name]["long_name"] = i.long_name
        dict[i.short_name]["iso_code"] = i.iso_code
        dict[i.short_name]["iso_short"] = i.iso_short
        dict[i.short_name]["iso_long"] = i.iso_long
        dict[i.short_name]["capital"] = i.capital
